import { eleves, enseignants, paiements } from '@/lib/data'
...
export default function Dashboard() {
  ...
  const impayés = eleves.filter(e => e.status === 'unpaid').length
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Centre Zaïd Ibn Thabit — Lundi 07 Juillet 2025
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-400 mt-1">Classes actives</div>
          <div className="text-xs text-[#2d6a2d] font-medium mt-2">▲ +3 ce mois</div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-400 mt-1">Internat 11 mois/12</div>
          <div className="text-xs text-[#c8961a] font-medium mt-2">▲ Complet</div>
        </div>

        <div className="bg-white rounded-xl p-4 border border-gray-100 relative overflow-hidden">
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#1a4fa0] rounded-l-xl"/>
          <div className="text-xs text-gray-400 uppercase tracking-wide mb-2">Encaissé ce mois</div>
          ...
          <div className="text-xs text-[#1a4fa0] font-medium mt-2">▲ +6% vs préc.</div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-3xl font-bold text-[#1a2818]" style={{fontFamily:'Georgia,serif'}}>{impayés}</div>
          <div className="text-xs text-gray-400 mt-1">À relancer</div>
          <div className="text-xs text-red-500 font-medium mt-2">↓ Requiert action</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100">
          ...
          <div className="p-4 flex flex-col gap-2">
            ...
            <div className="flex gap-2 items-start bg-red-50 text-red-800 text-xs p-3 rounded-lg">
              <span className="w-1.5 h-1.5 rounded-full bg-red-500 mt-1 flex-shrink-0"/>
              <span><strong>{impayés} familles impayées</strong> — Relance J+5 requise</span>
            </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          <span className="text-sm font-medium text-[#1a2818]">Élèves inscrits récemment</span>
